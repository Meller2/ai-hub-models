...
Use our lightweight command-line interface to inspect and download Qwen2-7B-Instruct:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Qwen2-7B-Instruct

# Print performance and accuracy metrics
qai-hub-models perf Qwen2-7B-Instruct
qai-hub-models numerics Qwen2-7B-Instruct

# Download a ready-to-deploy asset
qai-hub-models fetch Qwen2-7B-Instruct --runtime qnn_context_binary --precision w4a16
```
