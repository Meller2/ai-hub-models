...
Use our lightweight command-line interface to inspect JAIS-6p7b-Chat:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info JAIS-6p7b-Chat

# Print performance and accuracy metrics
qai-hub-models perf JAIS-6p7b-Chat
qai-hub-models numerics JAIS-6p7b-Chat
