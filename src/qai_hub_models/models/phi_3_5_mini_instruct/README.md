...
Use our lightweight command-line interface to inspect and download Phi-3.5-Mini-Instruct:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Phi-3.5-Mini-Instruct

# Print performance and accuracy metrics
qai-hub-models perf Phi-3.5-Mini-Instruct
qai-hub-models numerics Phi-3.5-Mini-Instruct
